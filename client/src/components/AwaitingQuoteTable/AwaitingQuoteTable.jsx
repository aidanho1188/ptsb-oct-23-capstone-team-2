...
import './awaitingQuote.css'

function AwaitingQuoteTable() {
    ...
    <div className='table'>
      ...
      <Table className='table-container'>
        ...
        <ScrollArea className='scroll rounded-md border p-4'>
          <TableCaption>A list of on awaiting quote workorders.</TableCaption>
          <TableBody>
...
export default AwaitingQuoteTable
