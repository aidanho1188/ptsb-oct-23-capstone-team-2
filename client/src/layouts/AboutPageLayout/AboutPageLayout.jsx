    ...
    <div className='about-page-content'>
      ...
      <div className='how-it-works'>
        ...
        <div className='how-it-works-content'>
          ...
          {activePage === 'check-in-out' && <p>Use the Check-In and Check-Out pages to manage specific work orders. Check in or check out a work order to update its status accordingly.</p>}

          {activePage === 'create-work-order' && <p>The Create Work Order page allows you to generate new work orders. Fill in the necessary details, and the system will create a work order and assign a unique ID.</p>}

          {activePage === 'update-status' && <p>On the Update Status page, you can change the status of any work order. This page also records the status update in our database for future reference.</p>}

          {activePage === 'work-order-activity' && <p>Visit the Work Order Activity page to view all activities related to a specific work order. This includes a log of changes and actions taken on that work order.</p>}
        </div>
      </div>
